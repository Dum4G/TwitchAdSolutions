...
(function() {
    ...
    function declareOptions(scope) {
        ...
        scope.FastAutoplayFirstTry = false;// Hybrid B: armed breaks let first Source probe go normally, jump to autoplay only on contamination. Detects Source recovery automatically. Opt-in: twitchAdSolutions_fastAutoplayFirstTry=true.
    ...
    async function processM3U8(url, textStr, realFetch) {
        ...
        if (haveAdTags) {
            ...
            // Trades 0.7s vs prior autoplay-first behavior for guaranteed Source-recovery
            ...
            if (backupM3u8 && streamInfo.IsShowingAd) {
                ...
                if (streamInfo.ActiveBackupPlayerType != backupPlayerType) {
                    ...
                    if (streamInfo.EscapeHatchFired) {
                        ...
                        // Arm signal: full Source-tier exhaustion OR hybrid-skip path (first Source dirty).
